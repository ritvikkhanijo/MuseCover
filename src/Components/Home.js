...
class Home extends Component {
	...
	render() {
		return (
			<React.Fragment>
				<iframe title="github-star" className="center star-github" src="https://github.com/ritvikkhanijo" frameborder="0" scrolling="0" width="170px" height="20px"></iframe>
				<a href="https://github.com/ritvikkhanijo">
